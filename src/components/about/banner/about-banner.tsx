                ...
                <div className="row align-items-center">
                    <div className="col-lg-12">
                        <div className="tp-about-banner mb-80">
                            <span>At SmartKriya</span>
                            <h3 className="tp-about-banner-title">
                                We turn potential <br /> into perfomance.
                            </h3><br />
                            <h4>Our industry-aligned training programs prepare students <br />for the jobs of today and the careers of tomorrow</h4>
                        </div>
                    </div>
